        ...
        <div class="graphs">
            @if ($id == 0)
                <div class="content-box-wrapper">
                    ...
                    @endif ()
                    <form action="{{route('admin.post.postEdit', $post[0]->id)}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="form-group">
                            <label>Tiêu đề</label>
                            <input class="form-control1" type="text" name="txtTitle" placeholder="Your name here" value="{{$post[0]->title}}">
                        </div>
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea id="editor2" name="txtDescription">{!! $post[0]->description !!}</textarea>
                            <script>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor1" name="txtContent">{!! $post[0]->content !!}</textarea>
                            <script>
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{url($post[0]->images)}}" width="300px">
                        </div>
                        <div class="form-group">
