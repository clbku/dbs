				...
				<div class="graphs">
					...
					<div class="graph_box">
						...
						<div class="col-md-4 grid_2">
							<div class="grid_1">
								<h4>Radar</h4>
								<canvas id="radar" height="375" width="587" style="width: 470px; height: 300px;"></canvas>
									<script>
										var radarChartData = {
											labels : ["","","","","","",""],
											datasets : [
						...
						<div class="col-md-4 grid_2">
							<div class="grid_1">
								<h4>PolarArea</h4>
								<canvas id="polarArea" height="375" width="562" style="width: 450px; height: 300px;"></canvas>
								<script>
									var chartData = [
										{
											value : Math.random(),
					...
					<div class="graph_box1">
						...
						<div class="col-md-6 grid_2 grid_2_bot">
							<div class="grid_1">
								<h4>Line</h4>
								<canvas id="line1" height="125" width="750" style="width: 600px; height: 100px;"></canvas>
								<script>
										var lineChartData = {
							...
							<div class="line-bottom-grid">
								<div class="grid_1">
									<h4>Bar</h4>
									<canvas id="bar1" height="125" width="750" style="width: 600px; height: 100px;"></canvas>
									<script>
										var barChartData = {
